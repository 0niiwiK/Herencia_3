...
public class Prueba {
    /**
     * Método main que crea dos inmuebles, calcula su precio de * acuerdo al área y se muestran sus datos en pantalla
     */
    public static void main(String args[]) {
        ...
        apto1.imprimir();
        System.out.println();
        System.out.println("Datos apartamento estudio");
